const STRINGS = {
  en: {
    ...
    rest: "Rest",
    rest_skip: "Skip",
    rest_start: "Start rest",
    share_session: "Share",
    print_session: "Print",
    share_copied: "Session copied to clipboard",
    share_failed: "Could not share",
    install_hint: "Install this app from your browser menu for gym-floor use.",
    voice_title: "Workout start voice",
    voice_lede:
      "Upload or record your own clip. It plays when a workout starts; system Hebrew TTS is the fallback.",
    voice_none: "No custom clip yet — using spoken TTS.",
    voice_ready: "Custom clip saved on this device.",
    voice_upload: "Upload audio",
    voice_record: "Record",
    voice_recording: "Stop recording",
    voice_preview: "Preview",
    voice_clear: "Clear",
    voice_saved: "Clip saved.",
    voice_cleared: "Clip cleared — back to TTS.",
    voice_mic_denied: "Microphone permission denied.",
    voice_too_large: "Audio too large (max 5MB).",
  ...
  he: {
    ...
    rest: "מנוחה",
    rest_skip: "דלג",
    rest_start: "התחל מנוחה",
    share_session: "שיתוף",
    print_session: "הדפסה",
    share_copied: "האימון הועתק ללוח",
    share_failed: "השיתוף נכשל",
    install_hint: "התקינו את האפליקציה מתפריט הדפדפן לשימוש בחדר כושר.",
    voice_title: "קול לתחילת אימון",
    voice_lede: "העלו או הקליטו קליפ משלכם. הוא יושמע בתחילת אימון; אם אין — TTS בעברית.",
    voice_none: "אין קליפ מותאם — משתמשים ב־TTS.",
    voice_ready: "קליפ מותאם נשמר במכשיר הזה.",
    voice_upload: "העלאת שמע",
    voice_record: "הקלטה",
    voice_recording: "עצרו הקלטה",
    voice_preview: "השמעה",
    voice_clear: "מחיקה",
    voice_saved: "הקליפ נשמר.",
    voice_cleared: "הקליפ נמחק — חזרה ל־TTS.",
    voice_mic_denied: "אין הרשאה למיקרופון.",
    voice_too_large: "הקובץ גדול מדי (עד 5MB).",
